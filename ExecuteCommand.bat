...
call "TotalTestFTCLI.bat" -e "10.100.4.82:16196" ^ -passticket ^ -f "%~dp1CLI_CWKTCOBX\Tests\Scenarios" ^ -R -g TTTReport -G -v 6 -l CLI ^ -log DEBUG ^ -cfgdir "%~dp1TotalTestConfiguration"
