...
rem  * 
rem  * Copyright (c) 2018 Compuware Corporation. All rights reserved.
rem  */
rem 
...
set LOGBACK_SUFFIX=workspace\configuration\topaz_logback.xml
set APPLICATION=com.compuware.frameworks.hostservices.cli.zosutil.ZosUtilitiesCli
